<template>
  <div class="ma-banner-login">
    <div class="ma-banner-login__content">
      <svg
        width="17"
        height="16"
        viewBox="0 0 17 16"
      ...
      <div class="ma-banner-login__content-description" v-html="lnContent()" />
    </div>
...
const lnContent = computed(() => (lang: 'en' | 'id' = 'en') => {
  if (lang === 'en')
    return 'Login to autofill data and get <b>special prices!</b>';
  return 'Login untuk mengisi data otomatis dan dapatkan <b>harga spesial!</b>';
});
</script>
...
.ma-banner-login__content {
  ...
  .ma-banner-login__content-description {
    color: white;
